    ...
    public static DupLoad visit(Instruction instruction, DupStore dupStore)
    {
        ...
        case ByteCodeConstants.DUPSTORE,
            ByteCodeConstants.TERNARYOPSTORE,
             ...
             Const.MONITOREXIT,
             Const.POP:
            return visit(((ObjectrefAttribute)instruction).getObjectref(), dupStore);
        case ByteCodeConstants.STORE,
             ByteCodeConstants.XRETURN,
             Const.ASTORE,
             Const.ISTORE,
             Const.PUTSTATIC:
            return visit(((ValuerefAttribute)instruction).getValueref(), dupStore);
        ...
        case Const.LOOKUPSWITCH, Const.TABLESWITCH:
            return visit(((Switch)instruction).getKey(), dupStore);
