package jd.core.instruction.bytecode.analyzer;
				...
				(opcode == ByteCodeConstants.IFXNULL))
			{
				...
				if (jumpOffset == lastBiJumpOffset)
				{
					if ((bi.branch > 0) && 
						...
						(instruction.lineNumber+2 <= nextInstruction.lineNumber))
					{
						// Amelioration par rapport JAD : possibilite de 
