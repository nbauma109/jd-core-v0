...
public class ByteCodeConstants 
{
	...
	public static final int PREINC                    = 276;
	public static final int POSTINC                   = 277;	
	public static final int RETURNADDRESSLOAD         = 278;	
	public static final int TERNARYOPSTORE            = 279;
	public static final int TERNARYOP                 = 280;
	public static final int INITARRAY                 = 281;
	public static final int NEWANDINITARRAY           = 282;
	public static final int COMPLEXIF                 = 283;
	public static final int OUTERTHIS                 = 284;
	public static final int ASSERT                    = 285;
