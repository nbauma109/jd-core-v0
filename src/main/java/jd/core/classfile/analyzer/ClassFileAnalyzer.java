...
import jd.core.instruction.bytecode.InstructionListBuilder;
...
import jd.core.instruction.bytecode.reconstructor.AssignmentInstructionReconstructor;
import jd.core.instruction.bytecode.reconstructor.DotClass118AReconstructor;
import jd.core.instruction.bytecode.reconstructor.DotClass14Reconstructor;
import jd.core.instruction.bytecode.reconstructor.DupStoreThisReconstructor;
import jd.core.instruction.bytecode.reconstructor.NewInstructionReconstructor;
import jd.core.instruction.bytecode.reconstructor.OuterReferenceReconstructor;
import jd.core.instruction.bytecode.reconstructor.PostIncReconstructor;
import jd.core.instruction.bytecode.reconstructor.PreIncReconstructor;
import jd.core.instruction.bytecode.reconstructor.SimpleNewInstructionReconstructor;
import jd.core.instruction.bytecode.visitor.ReplaceStringBuxxxerVisitor;
import jd.core.instruction.bytecode.visitor.SetConstantTypeInStringIndexOfMethodsVisitor;
import jd.core.instruction.fast.FastConstants;
import jd.core.instruction.fast.FastInstructionListBuilder;
import jd.core.instruction.fast.analyzer.DupLocalVariableAnalyzer;
import jd.core.instruction.fast.instruction.FastLabel;
import jd.core.instruction.fast.reconstructor.InitInstanceFieldsReconstructor;
import jd.core.instruction.fast.reconstructor.InitStaticFieldsReconstructor;
